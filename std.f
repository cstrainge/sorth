...
: show-bytecode immediate description: "For words written in Forth, show it's generated bytecode."
                          signature: "show-bytecode <word_name>"
    word token.text@ op.push_constant_value
    ` show-bytecode op.execute
;



: show-ir immediate description: "For words written in Forth, show it's intermediate representation."
                    signature: "show-ir <word_name>"
    word token.text@ op.push_constant_value
    ` show-ir op.execute
;
